...
$(function () {
  ...
  $timeBlocks.each(function() {
    ...
    var timeClass
    // getting content of each text area
    var $hourBlockValue = $(this).val()

    text[$hourBlock] = $hourBlockValue

    var $buttons = $timeBlocks.parent().find('button')
    
    $buttons.on('click', function() {
      localStorage.setItem($hourBlock, $hourBlockValue)
    })
